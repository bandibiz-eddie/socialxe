<?php
    ...
    $lang->about_client_token = '소셜XE 사이트에서 발급받은 Client Token을 입력하세요.';
    $lang->server_hostname = '소셜XE 서버의 이름';
    $lang->about_server_hostname = '소셜XE 기능을 요청할 서버의 도메인을 입력해주세요.';
    $lang->server_query = '소셜XE 서버 경로';
    $lang->about_server_query = '소셜XE 기능을 요청할 query url을 입력해 주세요.';
    $lang->use_ssl = 'SSL 연결';
    $lang->about_use_ssl = '소셜XE 서버와 통신할 때 보안연결을 사용합니다.';
    $lang->hashtag = '태그';
    ...
    $lang->msg_request_error = '소셜XE 서버에 API 요청이 실패했습니다.';
